...
func GetQuote(q, keyID, keyPem string) ([]byte, error) {
	return gokalshi.Request[[]byte]("/communications/quotes/"+q, "GET", keyID, keyPem, true)
}

func DeleteQuote(q, keyID, keyPem string) ([]byte, error) {
	return gokalshi.Request[[]byte]("/communications/quotes/"+q, "DELETE", keyID, keyPem, true)
}

func AcceptQuote(q string, opts struct {
	AcceptedSide string `json:"accepted_side"`
}, keyID, keyPem string) ([]byte, error) {
	return gokalshi.Request[[]byte]("/communications/quotes"+q+"/accept", "GET", keyID, keyPem, true, opts)
}

func ConfirmQuote(q, keyID, keyPem string) ([]byte, error) {
	return gokalshi.Request[[]byte]("/communications/quotes/"+q+"/confirm", "PUT", keyID, keyPem, true)
}
